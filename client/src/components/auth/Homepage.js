      ...
      <div className="home-page">
          <div className="home-page--top-profil">
            ...
            <div className="profils">
              {maids.map((maid, i) => 
                (i < 5 && !!maid.rating && !!maid.imageProfil) && (
                  <RatedProfil stars={maid.rating} img={maid.imageProfil} name={maid.username} key={i} />
                ))
              }
            </div>
          </div>
          ...
          <div className="home-page--services">
            ...
            {services.map(service => <ServiceItem  serviceValue={[Object.keys(service)]} serviceName={Object.values(service) + ""} />)}
            {/*
